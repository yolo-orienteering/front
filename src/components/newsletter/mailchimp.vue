...
<template>
  <div class="row q-pt-lg">
    ...
    <div v-show="!subscribed" class="col-12 ">
      ...
      <p class="text-body1">Wir informieren dich sporadisch, wenn o-mate neue Funktionen bekommt. Oder es interessante
        Neuigkeiten aus der OL-Welt gibt.</p>
      <div ref="mailchimpForm" v-html="mailchimpHtmlCode" @submit.capture="handleSubscription()" />
    </div>
  </div>
</template>
